/**
 * BIOGENIOS - Banco de preguntas
 * -------------------------------
 * Cada pregunta tiene esta forma:
 * {
 *   id: identificador único (string),
 *   modulo: "verano" | "semestral1" | "semestral2" | "temas",
 *   tema: nombre del tema (ej. "Citología", "Genética", "Ecología"...),
 *   pregunta: texto de la pregunta,
 *   alternativas: array de 4 o 5 strings (NO pre-ordenadas, se mezclan en runtime),
 *   correctaIndex: índice (dentro de "alternativas", en el orden en que las escribiste aquí)
 *                  que es la respuesta correcta,
 *   explicacion: texto breve que se muestra como feedback al responder.
 * }
 *
 * Para agregar más preguntas: copia un bloque y pégalo dentro del array PREGUNTAS.
 * No es necesario mezclar las alternativas aquí: la app las mezcla cada vez que se carga.
 */
...
// Catálogo de módulos (para construir el menú y los filtros)
const MODULOS = [
  { id: "diario",      nombre: "Pregunta del Día",          icono: "📌" },
  { id: "verano",       nombre: "Verano",                    icono: "☀️" },
  { id: "semestral1",   nombre: "Semestral 1",               icono: "📘" },
  { id: "semestral2",   nombre: "Semestral 2 Intensivo",     icono: "🔥" },
  { id: "temas",        nombre: "Temas Específicos",         icono: "🧬" }
];
